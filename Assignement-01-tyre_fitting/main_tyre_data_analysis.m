...
data_label = string('Fitted data');
plot_fitted_data(KAPPA_vec, TDataGamma.FX, KAPPA_vec, FX0_varGamma_vec, '$\kappa$ [-]', '$F_{X}$ [N]', data_label, 'fig_fit_variable_camber_FX', 'Fitting with variable camber', line_width, font_size_title)
