...
label = "Fitted data";
% figure 4
plot_fitted_data(TData0.SL, TData0.FY, TData0.SL, FY0_guess, '$\alpha [-]$', '$F_{Y0}$ [N]', label, 'fig_fit_guess_FY', 'Fitting with initial guess', line_width, font_size_title)
...
ALPHA_vec = TData0.SL;  % slip ratio
