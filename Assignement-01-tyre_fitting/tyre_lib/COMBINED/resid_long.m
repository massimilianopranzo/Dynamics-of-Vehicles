function res = resid_long(P,FX,KAPPA,ALPHA,GAMMA,FZ,tyre_data)
    ...
    tmp_tyre_data.rHx1 = P(1); 
    tmp_tyre_data.rBx1 = P(2);
    tmp_tyre_data.rCx1 = P(3);
    tmp_tyre_data.rBx2 = P(4);
   ...
   %dfz = (Z - Fz0)./Fz0 ;
    ...
    for i=1:length(KAPPA)
      [Gxa, ~, ~] =  MF96_FXFYCOMB_coeffs_eqns(KAPPA(i), ALPHA(i), GAMMA(i), FZ(i), tmp_tyre_data);
      fx0  = Gxa * MF96_FX0(KAPPA(i), 0, GAMMA(i), FZ(i), tmp_tyre_data);
      res = res+(fx0-FX(i))^2;
