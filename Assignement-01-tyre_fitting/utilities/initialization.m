...
font_size_title = 26; % font size for the titles
font_size = 26;       % font size for the labels
line_width = 4;       % line width for the plots
...
out_file_name = 'results_to_latex.tex';
