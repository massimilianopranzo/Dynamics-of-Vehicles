function vehicle_data = getVehicleDataStruct_old()
  ...
  % VEHICLE    
  vehicle.Lf    = 1.5;  % [m] Distance between vehicle CoM and front wheels axle      
  vehicle.Lr    = 1.7;  % [m] Distance between vehicle CoM and front wheels axle      
