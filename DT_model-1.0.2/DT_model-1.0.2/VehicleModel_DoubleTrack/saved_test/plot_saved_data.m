...
ylabel('$K_{US}$')
if enable_export == 1
    export_figure(fig_stiff, '\fig_var_stiff.eps', 'images\');
end

fig_gamma = figure('Color','w');
subplot(1,2,1)
hold on; grid on; box on;
plot(s0_t0_c0.Ay_hand, s0_t0_c0.handling, 'LineWidth',2, 'DisplayName','Ref')
plot(s0_t0_cp1.Ay_hand, s0_t0_cp1.handling, '--', 'LineWidth',2, 'DisplayName','$\gamma = +1 [^\circ]$')
...
ylabel('$K_{US}$')
if enable_export == 1
    export_figure(fig_gamma, '\fig_gamma.eps', 'images\');
end


fig_delta = figure('Color','w');
subplot(1,2,1)
hold on; grid on; box on;
plot(s0_t0_c0.Ay_hand, s0_t0_c0.handling, 'LineWidth',2, 'DisplayName','Ref.')
plot(s0_tp1_c0.Ay_hand, s0_tp1_c0.handling, '--', 'LineWidth',2, 'DisplayName','$\delta = +1 [^\circ]$')
...
ylabel('$K_{US}$')
if enable_export == 1
    export_figure(fig_delta, '\fig_delta.eps', 'images\');
end